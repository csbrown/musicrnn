...
class Translator(object):
	...
	def __init__(self, input_path):
		...
		self.divisions = int(attributes.find('divisions').text)
	...
	# the duration needs to be translated to parts of 48.  This allows us to represent whole notes and triplets of 16th notes.  Code these starting at ascii 33 up through 48... the note needs to be translated to a char from 128 to 254 somehow... code middle c as ascii 192					
	def note_to_text(self, note):
		divs_per_beat = self.divisions * self.beats
		to_48parts = 48 / divs_per_beat
		if 48. / divs_per_beat != to_48parts:
			raise Exception("cant translate this to parts of 48!")
